...
**ColorModelsApp** — приложение для исследования цветовых моделей и переходов между ними на языке C++ с использованием библиотеки Qt.
...
- **ColorModelsApp**: основной класс приложения, наследующийся от `QMainWindow`.
...
2. **Склонируйте репозиторий**:
   ...
   ```bash
   git clone https://github.com/your-repository/ColorModelsApp.git
   ```
...
- Для добавления новых моделей можно расширять класс `ColorModelsApp`, добавляя соответствующие методы пересчета и элементы управления.
